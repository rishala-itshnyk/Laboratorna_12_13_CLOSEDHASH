...
// Структура для зберігання студентських даних
...
public class Program
{
    ...
    public static void AddStudent(ClosedHashTable hashTable)
    {
    ...
    public static void SearchStudent(ClosedHashTable hashTable)
    {
    ...
    static void DeleteStudent(ClosedHashTable hashTable)
    {
    ...
    public void AddStudent(string hashTable, int[] grades)
    {
        throw new NotImplementedException();
    }

    public bool SearchStudent(string hashTable, out int[] ints)
    {
        throw new NotImplementedException();
    }
}
